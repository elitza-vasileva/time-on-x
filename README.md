...
`npm run package` creates `dist/time-on-x-extension-v1.5.2.zip`. The official InstantDB SDK is bundled into the package; no JavaScript is loaded from a remote server at runtime.
